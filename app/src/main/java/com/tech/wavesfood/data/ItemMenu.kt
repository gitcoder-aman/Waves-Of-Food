...
val itemMenuList = listOf(
    ItemMenu(0, R.drawable.menu1,"Herbal Pancake fadshfklhasdl fjah",10,"short desc","ingredients"),
    ItemMenu(1, R.drawable.menu2,"Fruite Salad",20,"short desc","ingredients"),
    ItemMenu(2, R.drawable.menu3,"Green Noddle",40,"short desc","ingredients"),
    ItemMenu(3, R.drawable.menu4,"Chocolate cake",50,"short desc","ingredients"),
